...
issues = [{:name => 'KevinYao', :action => 'talking to him', :date_entered => '25-Nov-1992', :votes => 0, :as_a => '169 TA', :so_that => 'I can do my job', :i_want => 'to fail him'},
		  {:name => 'Airbears', :action => 'Watching Hulu', :date_entered => '25-Dec-2001', :votes => 0, :as_a => 'student', :so_that => 'I can watch hulu', :i_want => 'get internet access'},
		  ...
		  {:name => 'Telebears', :action => 'signing up for classes', :date_entered => '1-Feb-2011', :votes => 0, :as_a => 'administrator', :so_that => 'mess with students', :i_want => 'to make telebers suck'},
  	 ]

...
Scenario: see question panel displayed
  Given I am in Developer page for issue "Airbears" with the correct information displayed
  And I see the story "As a user of Airbears So that I can watch hulu I want to get internet access"
  Then I should see Question panel at the bottom
